...
router.get("/", async (req, res) => {
  try {
    ...
    const employeesOnLeave =
      Number(leaveResult.rows[0].total) || 0;
    ...
    /* ==================================================
       ...
       IMPORTANT:
       If you have a travel table, replace this query
       with your actual travel table.

       For now this returns 0 so the dashboard does
       not fail if no travel table exists.
    ================================================== */
